      ...
      <AnimatePresence>
        {detectedTitle && (
          ...
          >
            ...
            <p className="min-w-0 flex-1 truncate font-inter text-xs text-foreground/90">
              This looks like a <strong className="font-semibold text-foreground">{detectedTitle}</strong> form. Rename project?
            </p>
