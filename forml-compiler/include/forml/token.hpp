...
=======
    KW_UPLOAD,      // "upload"   — generic file upload input, configured via its own
                    ...
                    //              KW_FILE/KW_IMAGE/KW_PDF/KW_DOCUMENT below are kept
                    //              only so pre-existing .forml source keeps compiling;
                    //              the semantic analyzer normalizes them to Upload.
    KW_FILE,        // "file"     — DEPRECATED: generic file upload input
    KW_IMAGE,       // "image"    — DEPRECATED: file upload restricted to image types
